...
public interface DataDecoder {
     ...
     */
    SourceBlockDecoder sourceBlock(int sbn);
     ...
     */
    Iterable<SourceBlockDecoder> sourceBlockIterable();
     ...
     */
    Parsed<EncodingPacket> parsePacket(int sbn, int esi, byte[] symbols, boolean copySymbols);
     ...
     *                If {@code symbols} is {@code null}
     */
    Parsed<EncodingPacket> parsePacket(int sbn, int esi, byte[] symbols, int off, int len, boolean copySymbols);
     ...
     *                If {@code symbols} is {@code null}
     */
    Parsed<EncodingPacket> parsePacket(int sbn, int esi, ByteBuffer symbols, boolean copySymbols);
     ...
     */
    Parsed<EncodingPacket> parsePacket(SerializablePacket serPac, boolean copySymbols);
     ...
     */
    Parsed<EncodingPacket> parsePacket(byte[] array, boolean copySymbols);
     ...
     *                If {@code array} is {@code null}
     */
    Parsed<EncodingPacket> parsePacket(byte[] array, int off, int len, boolean copySymbols);
     ...
     */
    Parsed<EncodingPacket> parsePacket(ByteBuffer buffer, boolean copySymbols);
     ...
     */
    Parsed<EncodingPacket> readPacketFrom(DataInput in) throws IOException;
     ...
     */
    Parsed<EncodingPacket> readPacketFrom(ReadableByteChannel ch) throws IOException;
}
