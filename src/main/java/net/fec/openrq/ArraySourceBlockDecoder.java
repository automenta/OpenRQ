...
final class ArraySourceBlockDecoder implements SourceBlockDecoder {
        ...
        int symbOver)
    {
        ...
        ImmutableList<SourceSymbol> sourceSymbols = DataUtils.partitionSourceBlock(
            ...
            fecParams,
            arrayOff,
            SourceSymbol.class, (off, esi, T) -> ArraySourceSymbol.newSymbol(array, off, T));
    ...
    public boolean containsSourceSymbol(int esi) {
        ...
        symbolsState.symbolsStateLock.lock();
        try {
            return symbolsState.containsSourceSymbol(esi);
        }
        finally {

            symbolsState.symbolsStateLock.unlock();
        }
    }
    ...
    private enum SourceSymbolDataType {
    ...
    static SourceBlockState forceDecode(ArraySourceBlockDecoder decoder) {
        ...
        decoder.symbolsState.symbolsStateLock.lock();
        try {
            decoder.decode();
            ...
            decoder.symbolsState.symbolsStateLock.unlock();
        }
    }
}
