...
public final class ExtraChannels {
     ...
     */
    public static void readBytes(ReadableByteChannel ch, ByteBuffer buf) throws IOException {
     ...
     *             If an I/O error occurs while reading
     */
    public static char readChar(ReadableByteChannel ch) throws IOException {
     ...
     *             If an I/O error occurs while reading
     */
    public static float readFloat(ReadableByteChannel ch) throws IOException {
     ...
     *             If an I/O error occurs while reading
     */
    public static double readDouble(ReadableByteChannel ch) throws IOException {
     ...
     */
    private static final ThreadLocal<ByteBuffer> TINY_BUFFER_CACHE = ThreadLocal.withInitial(() -> ByteBuffer.allocateDirect(SizeOf.LONG));
