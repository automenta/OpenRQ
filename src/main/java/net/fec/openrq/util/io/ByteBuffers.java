...
public final class ByteBuffers {
    ...
    private static final ThreadLocal<ByteBuffer> ZERO_ARR_BUFFER = ThreadLocal.withInitial(() -> allocate(ZERO_BUFFER_CAPACITY, ARRAY_BACKED));
    private static final ThreadLocal<ByteBuffer> ZERO_DIR_BUFFER = ThreadLocal.withInitial(() -> allocate(ZERO_BUFFER_CAPACITY, DIRECT));
     ...
     */
    private static final ThreadLocal<ByteBuffer> CACHED_ARR_BUFFER = ThreadLocal.withInitial(() -> allocate(INITIAL_CACHED_BUFFER_SIZE, ARRAY_BACKED));
    private static final ThreadLocal<ByteBuffer> CACHED_DIR_BUFFER = ThreadLocal.withInitial(() -> allocate(INITIAL_CACHED_BUFFER_SIZE, DIRECT));
