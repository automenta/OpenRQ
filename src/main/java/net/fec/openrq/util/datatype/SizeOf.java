...
public final class SizeOf {
     ...
     */
    public static int bitsInBytes(int numBits) {
     ...
     *                If {@code numBits} is negative
     */
    public static int bitsInChars(int numBits) {
     ...
     *                If {@code numBits} is negative
     */
    public static int bitsInShorts(int numBits) {
     ...
     *                If {@code numBits} is negative
     */
    public static int bitsInInts(int numBits) {
     ...
     *                If {@code numBits} is negative
     */
    public static int bitsInLongs(int numBits) {
     ...
     *                If {@code numBits} is negative
     */
    public static int bitsInFloats(int numBits) {
     ...
     *                If {@code numBits} is negative
     */
    public static int bitsInDoubles(int numBits) {
