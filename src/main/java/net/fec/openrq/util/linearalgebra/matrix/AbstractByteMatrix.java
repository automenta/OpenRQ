...
public abstract class AbstractByteMatrix implements ByteMatrix {
     ...
     */
    private abstract static class AbstractIterator extends ByteVectorIterator {
     ...
     */
    private abstract static class AbstractNonZeroIterator extends ByteVectorIterator {
    ...
    protected static void ensureFactoryIsNotNull(Factory factory) {

        ensureArgumentIsNotNull(factory, "factory");
    }

    protected static void ensureArgumentIsNotNull(Object argument, String name) {
    ...
    protected static void ensureDimensionsAreCorrect(int rows, int columns) {
