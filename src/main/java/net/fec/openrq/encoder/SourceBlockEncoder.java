...
public interface SourceBlockEncoder {
    ...
    interface IterableBuilder {
         ...
         */
        IterableBuilder startAt(int esi);
         ...
         * @return this builder (for chained invocation)
         */
        IterableBuilder startAtInitialSourceSymbol();
         ...
         * @return this builder (for chained invocation)
         */
        IterableBuilder startAtInitialRepairSymbol();
         ...
         * @return this builder (for chained invocation)
         */
        IterableBuilder endAtFinalSourceSymbol();
     ...
     */
    EncodingPacket encodingPacket(int esi);
     ...
     * @see #numberOfSourceSymbols()
     */
    EncodingPacket sourcePacket(int esi);
     ...
     * @see #numberOfSourceSymbols()
     */
    EncodingPacket sourcePacket(int esi, int numSymbols);
     ...
     * @see #numberOfSourceSymbols()
     */
    EncodingPacket repairPacket(int esi);
     ...
     * @see #numberOfSourceSymbols()
     */
    EncodingPacket repairPacket(int esi, int numSymbols);
     ...
     */
    IterableBuilder newIterableBuilder();
     ...
     */
    Iterable<EncodingPacket> sourcePacketsIterable();
     ...
     * @see #newIterableBuilder()
     */
    Iterable<EncodingPacket> repairPacketsIterable(int numRepairPackets);
}
