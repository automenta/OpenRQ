...
public class ParameterIO {
    static final int DATA_LENGTH_SHIFT = (1 + SizeOf.UNSIGNED_SHORT) * Byte.SIZE;
    static final int NUM_SOURCE_BLOCK_SHIFT = (SizeOf.UNSIGNED_SHORT + 1) * Byte.SIZE;
    static final int INTERLEAVER_LENGTH_SHIFT = 1 * Byte.SIZE;
    static final int SRC_BLOCK_NUMBER_SHIFT = ESI_num_bytes * Byte.SIZE;
    ...
    public static long extractDataLength(long commonFecOTI) {
        ...
        return unsignDataLength(commonFecOTI >>> DATA_LENGTH_SHIFT);
    }
    ...
    public static int extractNumSourceBlocks(int schemeSpecFecOTI) {
        ...
        return unsignNumSourceBlocks(schemeSpecFecOTI >>> NUM_SOURCE_BLOCK_SHIFT);
    }
    ...
    public static int extractInterleaverLength(int schemeSpecFecOTI) {
        ...
        return unsignInterleaverLength(schemeSpecFecOTI >>> INTERLEAVER_LENGTH_SHIFT);
    }
    ...
    public static int extractSourceBlockNumber(int fecPayloadID) {
        ...
        return unsignSourceBlockNumber(fecPayloadID >>> SRC_BLOCK_NUMBER_SHIFT);
    }
    ...
    public static long buildCommonFecOTI(long dataLen, int symbolSize) {
        ...
        return (usF << DATA_LENGTH_SHIFT) | usT; // reserved bits are all zeroes
    }
    ...
    public static int buildSchemeSpecFecOTI(int numSrcBs, int interLen, int sAlign) {
        ...
        return (usZ << NUM_SOURCE_BLOCK_SHIFT) | (usN << INTERLEAVER_LENGTH_SHIFT) | usAl;
    ...
    public static int buildFECpayloadID(int sbn, int esi) {
        ...
        return (usSBN << SRC_BLOCK_NUMBER_SHIFT) | usESI;
    }
