...
import static net.fec.openrq.util.linearalgebra.TestingCommon.addInts;
import static net.fec.openrq.util.linearalgebra.TestingCommon.addIntsL;
import static net.fec.openrq.util.linearalgebra.TestingCommon.addLongs;
import static net.fec.openrq.util.linearalgebra.TestingCommon.exponentialDistribution;
...
public class DeriverParametersBoundsTest {
    ...
    public static Iterable<Object[]> getFECParams() {
        ...
        final BufferedObjects<Params> bufferedParams = new BufferedObjects<>(Fs.size()*Ps.size()*WSs.size());
