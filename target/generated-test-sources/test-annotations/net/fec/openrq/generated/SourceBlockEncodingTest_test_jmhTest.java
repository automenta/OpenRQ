...
import net.fec.openrq.generated.SourceBlockEncodingTest_jmhType;
public final class SourceBlockEncodingTest_test_jmhTest {
    ...
    public BenchmarkTaskResult test_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            SourceBlockEncodingTest_jmhType l_sourceblockencodingtest0_G = _jmh_tryInit_f_sourceblockencodingtest0_G(control);
            ...
            while (control.warmupShouldWait) {
                l_sourceblockencodingtest0_G.test();
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            test_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_sourceblockencodingtest0_G);
            ...
            if (control.isLastIteration()) {
                if (SourceBlockEncodingTest_jmhType.tearTrialMutexUpdater.compareAndSet(l_sourceblockencodingtest0_G, 0, 1)) {
                    try {
                        if (control.isFailing) throw new FailureAssistException();
                        if (l_sourceblockencodingtest0_G.readyTrial) {
                            l_sourceblockencodingtest0_G.readyTrial = false;
                        }
                    } catch (Throwable t) {
                        control.isFailing = true;
                        throw t;
                    } finally {
                        SourceBlockEncodingTest_jmhType.tearTrialMutexUpdater.set(l_sourceblockencodingtest0_G, 0);
                    }
                } else {
                    long l_sourceblockencodingtest0_G_backoff = 1;
                    while (SourceBlockEncodingTest_jmhType.tearTrialMutexUpdater.get(l_sourceblockencodingtest0_G) == 1) {
                        TimeUnit.MILLISECONDS.sleep(l_sourceblockencodingtest0_G_backoff);
                        l_sourceblockencodingtest0_G_backoff = Math.max(1024, l_sourceblockencodingtest0_G_backoff * 2);
                        if (control.isFailing) throw new FailureAssistException();
                        if (Thread.interrupted()) throw new InterruptedException();
                    }
                }
                synchronized(this.getClass()) {
                    f_sourceblockencodingtest0_G = null;
                }
            }
    ...
    public BenchmarkTaskResult test_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            test_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_sourceblockencodingtest0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult test_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            test_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_sourceblockencodingtest0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void test_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, SourceBlockEncodingTest_jmhType l_sourceblockencodingtest0_G) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult test_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            test_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_sourceblockencodingtest0_G);
            control.preTearDown();
    ...
    public static void test_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, SourceBlockEncodingTest_jmhType l_sourceblockencodingtest0_G) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile SourceBlockEncodingTest_jmhType f_sourceblockencodingtest0_G;
    
    SourceBlockEncodingTest_jmhType _jmh_tryInit_f_sourceblockencodingtest0_G(InfraControl control) throws Throwable {
        SourceBlockEncodingTest_jmhType val = f_sourceblockencodingtest0_G;
        if (val != null) {
            return val;
        }
        synchronized(this.getClass()) {
            try {
            if (control.isFailing) throw new FailureAssistException();
            val = f_sourceblockencodingtest0_G;
            if (val != null) {
                return val;
            }
            val = new SourceBlockEncodingTest_jmhType();
            Field f;
            f = net.fec.openrq.SourceBlockEncodingTest.class.getDeclaredField("srcsymbs");
            f.setAccessible(true);
            f.set(val, Integer.valueOf(control.getParam("srcsymbs")));
            f = net.fec.openrq.SourceBlockEncodingTest.class.getDeclaredField("symbsize");
            f.setAccessible(true);
            f.set(val, Integer.valueOf(control.getParam("symbsize")));
            val.setup();
            val.readyTrial = true;
            f_sourceblockencodingtest0_G = val;
            } catch (Throwable t) {
                control.isFailing = true;
                throw t;
            }
